...
<div className="mt-4">
  ...
  {(() => {
    ...
    // - দুইবার Enter দিলে মাঝে একটা খালি লাইন থাকবে (ঠিক এডিট
    //   বক্সে যেভাবে লেখা, হুবহু সেভাবেই দেখাবে) — কিন্তু নতুন
    //   টিক-মার্ক আইটেম হবে না।
    // - নতুন টিক-মার্ক আইটেম তৈরি হবে শুধুমাত্র তখনই যখন সরাসরি
