...
<div className="mt-4">
  ...
  {(product.description || "")
    // এন্টার (নিউলাইন) — এক বা একাধিকবার (ডাবল এন্টার সহ) — কখনোই
    // নতুন টিক-মার্ক আইটেম তৈরি করবে না। প্রতিটা লাইন আলাদাভাবে trim
    // করে খালি লাইনগুলো (ডাবল/একাধিক এন্টারের ফলে তৈরি হওয়া) বাদ
    // দিয়ে একটা স্পেস দিয়ে জোড়া লাগানো হচ্ছে। নতুন আইটেম তৈরি হবে
    // শুধুমাত্র তখনই যখন টেক্সটে সরাসরি পরপর ২টা (বা বেশি) স্পেস
    // (ডাবল স্পেস) টাইপ করা হবে — এন্টার/ডাবল এন্টার দিয়ে না।
    .split("\n")
    .map(line => line.trim())
    .filter(line => line !== "")
    .join(" ")
