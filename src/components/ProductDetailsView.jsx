...
<div className="mt-4">
  ...
  {(product.description || "")
    // মোবাইল কীবোর্ডে (Gboard/iOS) স্পেসে ডাবল-ট্যাপ করলে অনেক সময়
    // অটোমেটিক "। "/". " (দাঁড়ি) বসে যায় — তাই আসল ডাবল-স্পেস
    // ক্যারেক্টার টেক্সটে নাও পৌঁছাতে পারে। Enter কী কোনো কীবোর্ডেই
    // এভাবে অটোকারেক্ট হয় না, তাই এখন ডাবল-স্পেসের বদলে ডাবল এন্টার
    // (মাঝে একটা খালি লাইন) দিয়ে নতুন আইটেম শুরু হবে — নির্ভরযোগ্য।
    // একবার Enter দিলে শুধু লাইন জোড়া লেগে যাবে (একই আইটেম থাকবে),
    // দুইবার Enter (খালি লাইন) দিলেই নতুন টিক-মার্ক আইটেম হবে।
    .replace(/\r\n/g, "\n")
    .split(/\n\s*\n+/) // ১+ খালি লাইন = নতুন আইটেমের বিভাজক
    .map(block =>
      block
        .split("\n")
        .map(line => line.trim())
