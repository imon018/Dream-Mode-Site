...
export default function InvoiceActions({ order }) {
  ...
  // Both this customer-facing button and the admin Order Details page
  // now call the same shared generator (src/utils/generateInvoicePdf.js)
  // so there is only ever one PDF implementation to fix.
