    ...
    {categories.map((item) => (
      ...
      <div>
        ...
        <p className="text-xs text-gray-400 mt-1">
          যেভাবে ইচ্ছা লাইন ভেঙে/এন্টার দিয়ে লিখুন — এন্টার বা ডাবল
          এন্টার ঠিক যেভাবে লেখেন সেভাবেই (লাইন-ব্রেক/মাঝে খালি
          লাইন) দেখাবে। নতুন টিক-মার্ক আইটেম শুরু করতে চাইলে সেখানে
          স্পেস বাটনে ২ বার চাপুন (ডাবল স্পেস)।
        </p>
