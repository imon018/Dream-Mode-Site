    ...
    {categories.map((item) => (
      ...
      <div>
        ...
        <p className="text-xs text-gray-400 mt-1">
          প্রতিটা পয়েন্ট আলাদা টিক-মার্ক হিসেবে দেখাতে দুইটা লাইনের
          মাঝে একটা খালি লাইন রাখুন (Enter দুইবার চাপুন)। শুধু একবার
          Enter দিলে লাইনটা আগের পয়েন্টের সাথেই জোড়া লেগে যাবে।
        </p>
